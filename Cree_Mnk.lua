...
function init_gear_sets()
    ...
    feet={ name="Herculean Boots", augments={'Pet: "Dbl. Atk."+1','"Subtle Blow"+5','Quadruple Attack +1','Accuracy+20 Attack+20','Mag. Acc.+15 "Mag.Atk.Bns."+15',}},
    neck="Fotia Gorget",
    waist="Moonbow Belt",
    ...
    sets.precast.WSAcc = {a--mmo="Honed Tathlum",body="Manibozho Jerkin",back="Letalis Mantle",feet="Qaaxo Leggings"
	}
    ...
    sets.precast.WS['Shijin Spiral']   = set_combine(sets.precast.WS, {--ear1="Bladeborn Earring",ear2="Steelflash Earring",legs="Manibozho Brais",feet="Daihanshi Habaki"
	})
    ...
    sets.precast.WS['Cataclysm'] = {
        --head="Wayfarer Circlet",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Hecate's Earring",body="Wayfarer Robe",hands="Otronif Gloves",ring1="Acumen Ring",ring2="Demon's Ring",back="Toro Cape",waist="Thunder Belt",legs="Nahtirah Trousers",feet="Qaaxo Leggings"
		}
    ...
    sets.idle.Town = {ring1="Sheltered Ring",}
    
    sets.idle.Weak = {ring1="Sheltered Ring",}
    
    -- Defense sets
    sets.defense.PDT = {ring1="Sheltered Ring",}

    sets.defense.HP = {ring1="Sheltered Ring",}

    sets.defense.MDT = {ring1="Sheltered Ring",ring2="Defending Ring"}
