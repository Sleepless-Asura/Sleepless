...
function init_gear_sets()
    ...
    legs="Aya. Cosciales +2",
    feet={ name="Telchine Pigaches", augments={'Song spellcasting time -6%','Enh. Mag. eff. dur. +7',}},
    neck="Orunmila's Torque",
    waist="Witful Belt",
    ...
    sets.engaged = {
    range={ name="Linos", augments={'Attack+15','"Dbl.Atk."+2','Quadruple Attack +3',}},
	...
	range={ name="Linos", augments={'Attack+15','"Dbl.Atk."+2','Quadruple Attack +2',}},
    head="Aya. Zucchetto +2",
    body={ name="Bihu Jstcorps. +3", augments={'Enhances "Troubadour" effect',}},
    hands="Aya. Manopolas +2",
    legs="Aya. Cosciales +2",
    ...
    left_ring={name="Stikini Ring", bag="wardrobe4"},
    right_ring="Ilabrat Ring",
    back={ name="Intarabus's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}},
}
    ...
    sets.midcast['Magic Finale'] = {waist="Luminary Sash",legs="Fili Rhingrave +1"}
