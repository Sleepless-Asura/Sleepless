...
function init_gear_sets()
    ...
    sets.precast.FC.Impact = set_combine(sets.precast.FC['Elemental Magic'], {body="Twilight Cloak"})
    ...
    hands={ name="Telchine Gloves", augments={'"Conserve MP"+5','Enh. Mag. eff. dur. +3',}},
	...
	back={ name="Bookworm's Cape", augments={'INT+2','MND+3','"Regen" potency+10',}},
}
    ...
    sets.midcast.Cursna = {
        ...
        feet={ name="Vanya Clogs", augments={'"Cure" potency +5%','"Cure" spellcasting time -15%','"Conserve MP"+6',}}, --5 feet="Gendewitha Galoshes +1"
		}
    ...
    sets.midcast.Protectra = sets.midcast.Shell
    ...
    sub="Ammurapi Shield",
    head="Ipoca Beret",
    body={ name="Chironic Doublet", augments={'"Cure" potency +9%','MND+4',}},
    ...
    head={ name="Chironic Hat", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','Haste+1','Mag. Acc.+6','"Mag.Atk.Bns."+15',}},
    body={ name="Chironic Doublet", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','"Fast Cast"+5','Mag. Acc.+10','"Mag.Atk.Bns."+9',}},
    ...
    sub="Khonsu",--sub="Enki Strap",
    ammo="Pemphredo Tathlum",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+19 "Mag.Atk.Bns."+19','"Drain" and "Aspir" potency +8','INT+9','"Mag.Atk.Bns."+12',}},--head={ name="Chironic Hat", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','Haste+1','Mag. Acc.+6','"Mag.Atk.Bns."+15',}},
    ...
    sub="Khonsu",
    ammo="Pemphredo Tathlum",
	head={ name="Merlinic Hood", augments={'Mag. Acc.+19 "Mag.Atk.Bns."+19','"Drain" and "Aspir" potency +8','INT+9','"Mag.Atk.Bns."+12',}},
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+10','Magic burst dmg.+9%',}},
    hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    legs={ name="Amalric Slops +1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    feet={ name="Amalric Nails +1", augments={'Mag. Acc.+20','"Mag.Atk.Bns."+20','"Conserve MP"+7',}},
    neck="Mizu. Kubikazari",
	waist="Skrymir Cord", --waist="Hachirin-no-Obi",
    left_ear="Malignance Earring",
    right_ear="Barkaro. Earring",
