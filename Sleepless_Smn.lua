...
--set_style(86) 
    ...
    -- Fast Cast 77%
    sets.precast.FC = {
	head={ name="Merlinic Hood", augments={'"Mag.Atk.Bns."+9','"Fast Cast"+4',}}, --FC12
	body="Inyanga Jubbah +2", --FC11
	hands={ name="Merlinic Dastanas", augments={'"Mag.Atk.Bns."+14','"Fast Cast"+4','INT+13','Mag. Acc.+14',}}, --FC4
	legs="Lengo Pants", --FC5
	feet={ name="Merlinic Crackows", augments={'"Mag.Atk.Bns."+9','"Fast Cast"+7','INT+1','Mag. Acc.+15',}}, --FC12
	neck="Orunmila's Torque", --FC5
	waist="Embla Sash", --FC5
	left_ear="Loquac. Earring", --FC2
	right_ear="Malignance Earring", --FC2
	left_ring="Lebeche Ring", -- QM2
	right_ring="Kishar Ring", -- FC4
	back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Mag. Acc+20 /Mag. Dmg.+20','Pet: Mag. Acc.+10','"Fast Cast"+10','Pet: Damage taken -5%',}},
	--main={ name="Grioavolr", augments={'"Fast Cast"+6','INT+2','"Mag.Atk.Bns."+17',}}, -- +10
	--head="Amalric Coif +1", -- FC11
    ...
    sets.pet_midcast.Physical_BP = {
        ...
        ear2="Gelos Earring",--ear2="Kyrene's Earring", --ear2="Gelos Earring",
        body="Con. Doublet +3",--body="Glyphic Doublet +3", --body="Con. Doublet +3",  body="Call. Doublet +2",
        hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Blood Pact Dmg.+9',}},	
        ...
        waist="Regal Belt", --waist="Incarnation Sash",
    ...
    sets.pet_midcast.Physical_BP_AM3 = set_combine(sets.pet_midcast.Physical_BP, {
		...
		--ear2="Gelos Earring",
		--ring1={name="Varar Ring +1", bag="wardrobe2"},
		--ring1="Cath Palug Ring", --ring1={name="Varar Ring +1", bag="wardrobe2"},
	})
    ...
    sets.pet_midcast.Magic_BP_Base = {
        --main={ name="Nirvana", augments={'Path: A',}},
		main={ name="Grioavolr", augments={'Blood Pact Dmg.+9','Pet: Mag. Acc.+12','Pet: "Mag.Atk.Bns."+24','DMG:+22',}},
		sub="Elan Strap +1",
		ammo="Sancus Sachet +1",
		head={ name="Apogee Crown +1", augments={'MP+80','Pet: Attack+35','Blood Pact Dmg.+8',}}, -- body="Call. Doublet +2",
		body={ name="Apo. Dalmatica +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}}, -- body="Call. Doublet +2",
		hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+25 Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+10','Pet: Mag. Acc.+5',}},
    ...
    sets.pet_midcast.FlamingCrush = {
		...
		ammo="Sancus Sachet +1",
		head="Cath Palug Crown",
		body="Con. Doublet +3", -- body="Call. Doublet +2",
		hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+25 Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+10','Pet: Mag. Acc.+5',}},
		legs="Enticer's Pants", --legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},
		feet="Convoker's Pigaches +3", --feet={ name="Apogee Pumps +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}}, --feet="Convoker's Pigaches +3", 
		neck={ name="Smn. Collar +2", augments={'Path: A',}},
		waist="Regal Belt",
		left_ear="Lugalbanda Earring",
		right_ear="Gelos Earring",
		ring1={name="Varar Ring +1", bag="wardrobe2"},
        ring2={name="Varar Ring +1", bag="wardrobe4"},
		back={ name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Eva.+20 /Mag. Eva.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: "Regen"+10',}}, --back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Mag. Acc+20 /Mag. Dmg.+20','Pet: Mag. Acc.+10','"Fast Cast"+10','Pet: Damage taken -5%',}},
}
    ...
    sets.pet_midcast.MagicAcc_BP = {
        ...
        back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Mag. Acc+20 /Mag. Dmg.+20','Pet: Mag. Acc.+10','"Fast Cast"+10','Pet: Damage taken -5%',}},
		waist="Regal Belt",
        legs="Glyphic Spats +3", --legs="Convoker's Spats +3",
        feet="Convoker's Pigaches +3",
    }
    ...
    sets.pet_midcast.SummoningMagic = {
        ...
        sub="Vox Grip",
        ammo="Sancus Sachet +1",
        head="Beckoner's Horn +1", --head="Baayami Hat +1",
		neck="Incanter's Torque",
        ear2="Lodurr Earring",
		ear1="Cath Palug Earring",
        body="Baayami Robe",
		hands="Baayami Cuffs", --hands="Baayami Cuffs +1",
		legs="Baayami Slops", --legs="Baayami Slops +1",
		feet="Baayami Sabots", --feet="Baayami Sabots +1"
		ring1={name="Stikini Ring +1", bag="wardrobe2"}, 
		ring2="Evoker's Ring",
        back="Conveyance Cape",
		waist="Kobo Obi",
    ...
    sets.pet_midcast.Buff_Healing = set_combine(sets.pet_midcast.SummoningMagic, {
        main={ name="Nirvana", augments={'Path: A',}},
		head="Apogee Crown +1", --head="Beckoner's Horn +1",
    ...
    sets.aftercast.Perp_Base = {
        ...
        sub="Oneiros Grip",
        ammo="Sancus Sachet +1",
        head="Beckoner's Horn +1", --head="Convoker's Horn +1",
   ...
   -- Used when IdleMode is "Favor" to maximize avatar's favor effect.
    ...
    left_ring="Stikini Ring +1",
    right_ring="Evoker's Ring",
    back={ name="Conveyance Cape", augments={'Summoning magic skill +5','Pet: Enmity+10','Blood Pact Dmg.+3',}},
})
    ...
    sets.aftercast.Avatar_DT = {
        ...
        sub="Oneiros Grip",
        ammo="Sancus Sachet +1",
        head={ name="Selenian Cap", augments={'Attack+3','Pet: "Regen"+1','Attack+3','Pet: Damage taken -10%',}},--head={ name="Apogee Crown +1", augments={'Pet: Accuracy+25','"Avatar perpetuation cost"+7','Pet: Damage taken -4%',}},
        neck={ name="Smn. Collar +2", augments={'Path: A',}},
        ear2="Enmerkar Earring",
        ear1="Cath Palug Earring",
        body={ name="Apogee Dalmatica", augments={'Summoning magic skill +15','Enmity-5','Pet: Damage taken -3%',}},
    ...
    sets.aftercast.Spirit = {
        main={ name="Nirvana", augments={'Path: A',}},
        ammo="Sancus Sachet +1",
        head="Beckoner's Horn +1", --head="Convoker's Horn +2",
        neck="Incanter's Torque",
        ear2="Cath Palug Earring",
        ear1="Evans Earring",
        body="Baayami Robe",
	...
	Magic_BPs_NoTP = S{'Sonic Buffet','Tornado II','Clarsach Call','Holy Mist','Nether Blast','Aerial Blast','Searing Light','Diamond Dust','Earthen Fury','Zantetsuken','Tidal Wave','Judgment Bolt','Inferno','Howling Moon','Ruinous Omen','Night Terror','Thunderspark'}
	...
	Physical_BPs_TP = S{'Welt','Roundhouse','Hysteric Assault','Punch','Rock Throw','Barracuda Dive','Claw','Axe Kick','Shock Strike','Camisado','Regal Scratch','Poison Nails','Moonlit Charge','Crescent Fang','Rock Buster','Tail Whip','Double Punch','Megalith Throw','Double Slap','Eclipse Bite','Mountain Buster','Spinning Dive','Predator Claws','Rush','Chaotic Strike','Crag Throw','Volt Strike'}
	
	bp_hybrid = S{'Burning Strike','Flaming Crush'}
    
	bp_buff = S{"Wind's Blessing",'Chinook','Katabatic Blades','Shining Ruby','Frost Armor','Rolling Thunder','Crimson Howl','Lightning Armor','Ecliptic Growl','Hastega','Noctoshield','Ecliptic Howl','Dream Shroud','Earthen Armor','Fleet Wind','Inferno Howl','Soothing Ruby','Heavenward Howl','Soothing Current','Hastega II','Crystal Blessing'}
	
	bp_debuff = S{'Biter Elegy','Lunatic Voice','Lunar Cry','Mewing Lullaby','Nightmare','Lunar Roar','Slowga','Ultimate Terror','Sleepga','Eerie Eye','Tidal Roar','Diamond Storm','Shock Squall','Pavor Nocturnus'}
	
	bp_other = S{'Raise II','Aerial Armor','Reraise II','Glittering Ruby','Earthen Ward'} 
	
	AvatarList = S{'Siren','Shiva','Ramuh','Garuda','Leviathan','Diabolos','Titan','Fenrir','Ifrit','Carbuncle','Fire Spirit','Air Spirit','Ice Spirit','Thunder Spirit','Light Spirit','Dark Spirit','Earth Spirit','Water Spirit','Cait Sith','Alexander','Odin','Atomos'}
