...
-- Engaged Sets
    ...
    sets.engaged.HighAcc = {
		...
		body={ name="Valorous Mail", augments={'Accuracy+24','Weapon skill damage +3%','STR+6',}},
		hands="Flam. Manopolas +2",
		legs={ name="Valor. Hose", augments={'Mag. Acc.+24','Accuracy+15','Quadruple Attack +1','Accuracy+8 Attack+8',}},
